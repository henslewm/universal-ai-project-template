...
REQUIRED = [
    ...
    "EXECUTION_HARNESS_PROTOCOL.md", "config/execution-harness.schema.json", "config/execution-harness.example.json",
    ...
    "examples/software-hardware/packets/SHB-01-codec.contract.json",
    "examples/software-hardware/packets/SHB-02-transport.contract.json",
    "examples/software-hardware/packets/SHB-03-device.contract.json",
    "examples/software-hardware/packets/SHB-04-adapter.contract.json",
    "examples/software-hardware/packets/SHB-05-telemetry.contract.json",
    "examples/software-hardware/packets/SHB-06-workflow.contract.json",
    "examples/software-hardware/sample/synth_bridge/codec.py",
    "examples/software-hardware/sample/tests/test_integration.py",
